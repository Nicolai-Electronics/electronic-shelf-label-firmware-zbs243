...
void drawFullscreenMsg(const char *str)
{
    ...
    for (iteration = 0; iteration < SCREEN_DATA_PASSES; iteration++)
    {
        ...
        cdp.str = str;
        cdp.x = 0;//mathPrvI16Asr1(SCREEN_WIDTH - mathPrvMul8x8(CHAR_WIDTH * cdp.magnify, myStrlen(cdp.str)));
            ...
            if (r >= textRowEnd) {
                switch (rowIdx) {
                    ...
                    case 6:
                        ...
                        cdp.magnify = UI_MSG_MAGNIFY2;
                        cdp.foreColor = UI_MSG_FORE_COLOR_1;
                        cdp.str = pairCodeString(rowIdx - 3);
                        cdp.x = 0;
                        textRowEnd = textRow + CHAR_HEIGHT * cdp.magnify;
                        rowIdx += 1;
                        break;
                    ...
                    case 10:
                        ...
                        cdp.foreColor = UI_MSG_FORE_COLOR_2;
                        cdp.str = (const __xdata char *) "Nicolai";
                        cdp.x = 0;
                        textRowEnd = textRow + CHAR_HEIGHT * cdp.magnify;
                        break;
                    case 11:
                        ...
                        cdp.magnify = UI_MSG_MAGNIFY3;
                        cdp.foreColor = UI_MSG_FORE_COLOR_2;
                        cdp.str = (const __xdata char *) "    Electronics";
                        cdp.x = 0;
                        textRowEnd = textRow + CHAR_HEIGHT * cdp.magnify;
                        break;
                    case 12:
                        ...
                        cdp.magnify = UI_MSG_MAGNIFY3;
                        cdp.foreColor = UI_MSG_FORE_COLOR_1;
                        cdp.str = (const __xdata char *) "esl.electroc.at";
                        cdp.x = 0;
                        textRowEnd = textRow + CHAR_HEIGHT * cdp.magnify;
                        break;
                    case 13:
